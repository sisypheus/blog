...
export default function Header({ siteTitle, props }) {
  ...
  return (
    <div className={`z-10 transition ease-in duration-200 fixed top-0 w-full m-auto bg-transparent px-4 py-8 sm:max-w-xl md:max-w-full md:px-24 lg:px-24 ${top ? "" : " bg-gray-100"}`} >
      <div className="m-auto flex items-center justify-between">
        <p className={`font-bold ${top ? "text-white" : "text-black"} text-4xl tracking-wide`}>
          <Link to="/">
            {"<THEO'S BLOG>"}
          </Link>
        </p>
